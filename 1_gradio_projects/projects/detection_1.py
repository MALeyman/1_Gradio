...
image_path = os.path.join(ROOT_DIR, "data/files/3.jpg")
video_path = os.path.join(ROOT_DIR, "data/files/1.mp4")
model_path = os.path.join(ROOT_DIR, "data/models/retinaface_resnet50.onnx")
