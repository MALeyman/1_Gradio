...
def morph_video(im1, im2, n_frames=60):
    ...
    path_to_encoder = os.path.join(ROOT_DIR,  'data/models/encoder.pth')
    path_to_decoder = os.path.join(ROOT_DIR,  'data/models/decoder.pth')
    ...
    temp_dir = os.path.join(ROOT_DIR,  'data/temp_videos')
