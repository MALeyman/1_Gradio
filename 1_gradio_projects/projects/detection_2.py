...
image_path = os.path.join(ROOT_DIR, "data/files/4.jpg")
video_path = os.path.join(ROOT_DIR, "data/files/2.mp4")
model_path = os.path.join(ROOT_DIR, "data/models/yolo.onnx")
