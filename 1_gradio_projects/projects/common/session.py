...
model_path = os.path.join(BASE_DIR, os.pardir, os.pardir, "data/models/retinaface_resnet50.onnx")
model_path = os.path.normpath(model_path)  

model_path_2 = os.path.join(BASE_DIR, os.pardir, os.pardir, "data/models/yolo.onnx")
model_path_2 = os.path.normpath(model_path_2)  
